...
const mascotMessages = [
    ...
    "My Skills screaming and made this for you✨",
    "Meow meow! Having fun? leave a reply 🎉"
];
...
function typeMessage() {
    const messages = [
        ...
        '',
        'May 3 gift ako sayo, sana ma-appreciate mo',
        'at mapatawad ako.',
        '',
        Remember that your kindness makes the world brighter,',
        ...
        '',
        Hi po, if you have secret code try it po below. 🎁'
    ];
